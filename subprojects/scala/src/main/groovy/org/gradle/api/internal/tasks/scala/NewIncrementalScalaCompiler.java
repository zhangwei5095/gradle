...
import org.gradle.api.tasks.scala.incremental.SbtIncrementalCompiler;
import org.gradle.internal.UncheckedException;

import java.util.Collections;
import java.util.List;

public class NewIncrementalScalaCompiler implements org.gradle.api.internal.tasks.compile.Compiler<ScalaCompileSpec> {
    private static final Logger logger = Logging.getLogger(NewIncrementalScalaCompiler.class);
