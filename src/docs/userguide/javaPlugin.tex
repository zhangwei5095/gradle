...
\begin{center}
	\begin{tabular}{|l|l|l|} \hline
		...
		\href{\API tasks/bundling/Jar.html}{org.gradle.api.tasks.bundling.Jar} & fileSet, fileCollection & Zip \\ \hline
		\href{\API tasks/bundling/War.html}{org.gradle.api.tasks.bundling.War} & fileSet, fileCollection & Jar \\ \hline		
	\end{tabular}
\end{center}
